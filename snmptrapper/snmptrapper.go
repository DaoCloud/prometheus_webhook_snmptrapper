...
func init() {
	...
	trapOIDs.Severity, _ = snmpgo.NewOid("1.3.6.1.3.1977.1.1.2")
	trapOIDs.Description, _ = snmpgo.NewOid("1.3.6.1.3.1977.1.1.3")
	trapOIDs.TimeStamp, _ = snmpgo.NewOid("1.3.6.1.3.1977.1.1.4")
}
