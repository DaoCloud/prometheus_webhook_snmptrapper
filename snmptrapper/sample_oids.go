...
const (
	...
	oidPrometheusTrapperNotificationTimestamp   = "1.3.6.1.3.1977.1.1.1"    // Variable: timestamp
	oidPrometheusTrapperRecoveryAlert           = "1.3.6.1.3.1977.1.1.2"    // Variable: alert
	oidPrometheusTrapperNotificationInstance    = "1.3.6.1.3.1977.1.1.3"    // Variable: instance
	oidPrometheusTrapperNotificationApplication = "1.3.6.1.3.1977.1.1.4"    // Variable: application
	oidPrometheusTrapperNotificationTenant      = "1.3.6.1.3.1977.1.1.5"    // Variable: tenant
	oidPrometheusTrapperNotificationSeverity    = "1.3.6.1.3.1977.1.1.6"    // Variable: severity
	oidPrometheusTrapperNotificationDescription = "1.3.6.1.3.1977.1.1.7"    // Variable: description
)
